...
const BannerCard = () => {
  return (
    <div className="relative rounded-xl font-work mb-24">
      ...
      />
      <div className="absolute -bottom-16 left-4 md:left-4 rounded-xl p-4 md:p-10 bg-base-100 w-10/12 md:w-7/12 lg:w-6/12 shadow-[0_12px_24px_-6px] shadow-base-content/20">

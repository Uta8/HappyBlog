  ...
  return (
    <div className="card w-fit p-4 border border-base-content/10 rounded-xl font-work">
      ...
      <div className="card-body py-6 px-2">
        <span className="btn no-animation hover:bg-primary hover:text-primary-content bg-primary/5 border-0 text-primary tex-sm px-3 py-2 min-h-fit h-fit rounded-md w-fit capitalize font-medium">
          Technology
        </span>
        <h3>
          <Link
            href="/single-post"
            className="text-base-content hover:text-primary transition-all duartion-300 ease-in-out font-semibold text-lg md:text-xl lg:text-2xl mt-2"
          >
